...
// Tranches avec effectif > 5 (pour bonus score)
...
async function fetchBODACC(siren: string): Promise<BodaccInfo> {
  try {
    ...
    // Changement de dirigeant dans les 6 derniers mois
...
function calculateScore(
  ...
  // Procédure collective BODACC → -20
